...
CREATE TABLE tec.form1295_box123 (
	...
	businessCountryCode  char(3) REFERENCES tec.codes_countries , -- Business location country of business entity that filed this certificate
...
CREATE TABLE tec.form1295_interested_party (
	...
	partyCountryCode      char(3) REFERENCES tec.codes_countries, -- Business location country of interested party
