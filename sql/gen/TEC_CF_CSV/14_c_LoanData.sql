...
ALTER TABLE tec.c_LoanData
	...
	ADD FOREIGN KEY (loanStatusCd) REFERENCES tec.codes_loan_status NOT VALID,
	ADD FOREIGN KEY (lenderPersentTypeCd) REFERENCES tec.codes_persent_types NOT VALID,
	...
	ADD FOREIGN KEY (lenderStreetStateCd) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (guarantorPersentTypeCd1) REFERENCES tec.codes_persent_types NOT VALID,
	ADD FOREIGN KEY (guarantorNameSuffixCd1) REFERENCES tec.codes_name_suffixes NOT VALID,
	ADD FOREIGN KEY (guarantorNamePrefixCd1) REFERENCES tec.codes_name_prefixes NOT VALID,
	ADD FOREIGN KEY (guarantorStreetStateCd1) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (guarantorPersentTypeCd2) REFERENCES tec.codes_persent_types NOT VALID,
	ADD FOREIGN KEY (guarantorNameSuffixCd2) REFERENCES tec.codes_name_suffixes NOT VALID,
	ADD FOREIGN KEY (guarantorNamePrefixCd2) REFERENCES tec.codes_name_prefixes NOT VALID,
	ADD FOREIGN KEY (guarantorStreetStateCd2) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (guarantorPersentTypeCd3) REFERENCES tec.codes_persent_types NOT VALID,
	ADD FOREIGN KEY (guarantorNameSuffixCd3) REFERENCES tec.codes_name_suffixes NOT VALID,
	ADD FOREIGN KEY (guarantorNamePrefixCd3) REFERENCES tec.codes_name_prefixes NOT VALID,
	ADD FOREIGN KEY (guarantorStreetStateCd3) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (guarantorPersentTypeCd4) REFERENCES tec.codes_persent_types NOT VALID,
	ADD FOREIGN KEY (guarantorNameSuffixCd4) REFERENCES tec.codes_name_suffixes NOT VALID,
	ADD FOREIGN KEY (guarantorNamePrefixCd4) REFERENCES tec.codes_name_prefixes NOT VALID,
	ADD FOREIGN KEY (guarantorStreetStateCd4) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (guarantorPersentTypeCd5) REFERENCES tec.codes_persent_types NOT VALID,
	ADD FOREIGN KEY (guarantorNameSuffixCd5) REFERENCES tec.codes_name_suffixes NOT VALID,
	ADD FOREIGN KEY (guarantorNamePrefixCd5) REFERENCES tec.codes_name_prefixes NOT VALID,
	ADD FOREIGN KEY (guarantorStreetStateCd5) REFERENCES tec.codes_states NOT VALID,
