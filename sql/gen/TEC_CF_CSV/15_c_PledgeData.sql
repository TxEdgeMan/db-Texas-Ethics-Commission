...
ALTER TABLE tec.c_PledgeData
	...
	ADD FOREIGN KEY (pledgerPersentTypeCd) REFERENCES tec.codes_persent_types NOT VALID,
	...
	ADD FOREIGN KEY (pledgerStreetStateCd) REFERENCES tec.codes_states NOT VALID,
