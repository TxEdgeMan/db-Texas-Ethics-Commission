...
ALTER TABLE tec.c_FilerData
	...
	ADD FOREIGN KEY (filerJdiCd) REFERENCES tec.codes_filer_jdi NOT VALID,
	ADD FOREIGN KEY (committeeStatusCd) REFERENCES tec.codes_committee_status NOT VALID,
	...
	ADD FOREIGN KEY (filerPersentTypeCd) REFERENCES tec.codes_persent_types NOT VALID,
	...
	ADD FOREIGN KEY (filerStreetStateCd) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (filerMailingStateCd) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (filerFilerpersStatusCd) REFERENCES tec.codes_persent_types NOT VALID,
	...
	ADD FOREIGN KEY (treasPersentTypeCd) REFERENCES tec.codes_persent_types NOT VALID,
	...
	ADD FOREIGN KEY (treasStreetStateCd) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (treasMailingStateCd) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (treasFilerpersStatusCd) REFERENCES tec.codes_persent_types NOT VALID,
	ADD FOREIGN KEY (assttreasPersentTypeCd) REFERENCES tec.codes_persent_types NOT VALID,
	...
	ADD FOREIGN KEY (assttreasStreetStateCd) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (chairPersentTypeCd) REFERENCES tec.codes_persent_types NOT VALID,
	...
	ADD FOREIGN KEY (chairStreetStateCd) REFERENCES tec.codes_states NOT VALID,
	...
	ADD FOREIGN KEY (chairMailingStateCd) REFERENCES tec.codes_states NOT VALID,
