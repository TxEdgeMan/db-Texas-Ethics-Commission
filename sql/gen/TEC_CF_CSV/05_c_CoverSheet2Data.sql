...
ALTER TABLE tec.c_CoverSheet2Data
	...
	ADD FOREIGN KEY (notifierCommactPersentKindCd) REFERENCES tec.codes_persent_kind NOT VALID,
	ADD FOREIGN KEY (notifierPersentTypeCd) REFERENCES tec.codes_persent_types NOT VALID,
	...
	ADD FOREIGN KEY (notifierStreetStateCd) REFERENCES tec.codes_states NOT VALID,
