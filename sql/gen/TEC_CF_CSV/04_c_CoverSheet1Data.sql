...
ALTER TABLE tec.c_CoverSheet1Data
	...
	ADD FOREIGN KEY (sourceCategoryCd) REFERENCES tec.codes_source_category NOT VALID,
	ADD FOREIGN KEY (electionTypeCd) REFERENCES tec.codes_election_type NOT VALID,
	ADD FOREIGN KEY (politicalPartyCd) REFERENCES tec.codes_political_party NOT VALID,
	ADD FOREIGN KEY (politicalDivisionCd) REFERENCES tec.codes_political_division NOT VALID,
	ADD FOREIGN KEY (politicalPartyCountyCd) REFERENCES tec.codes_counties NOT VALID,
	ADD FOREIGN KEY (highContribThreshholdCd) REFERENCES tec.codes_contrib_threshold NOT VALID,
